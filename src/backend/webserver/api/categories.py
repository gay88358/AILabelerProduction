...
class Category(Resource):
    ...
    def get(self):
        ...
        return query_util.fix_ids(current_user.find_all_categories())
...
class Category(Resource):
    ...
    def get(self, category_id):
        ...
        category = current_user.find_category_by_id(category_id)
...
class CategoriesData(Resource):
    ...
    def get(self):
        ...
        categories = current_user.find_all_exist_categories()
