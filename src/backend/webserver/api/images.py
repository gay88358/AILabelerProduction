...
class Images(Resource):
    ...
    def get(self):
        ...
        images = current_user.find_all_images()
        total = images.count()
...
class ImageCopyAnnotations(Resource):
    ...
    def post(self, from_id, to_id):
        ...
        current_user.find_image_by_id(from_id)
        image_from = current_user.find_image_by_id(from_id)
        image_to = current_user.find_image_by_id(to_id)
