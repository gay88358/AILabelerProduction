...
class ImageModel(DynamicDocument):
    ...
    def find_images_by_dataset_id(dataset_id):
        try:
            ...
            raise ValueError("Image is not found given dataset id: " + str(dataset_id))

    @staticmethod
    def find_by(image_id):
        try:
            return ImageModel.objects.get(id=image_id)
        except:
            raise ValueError("Image is not found given id: " + str(image_id))
    ...
    def add_category_id_list(self, category_id_list_to_add):
        old_category_id_list = self.category_ids
        new_category_id = old_category_id_list + category_id_list_to_add
        self.update(set__category_ids=new_category_id)
    ...
    def add_num_annotation(self, num_annotation_to_add):
        ...
        self.update(
            set__annotated=True,
            set__num_annotations=new_num_annotations
        )

    def get_image_bound_size(self):
